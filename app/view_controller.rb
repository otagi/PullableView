class ViewController < UIViewController
  ...
  def viewDidLoad
    ...
    x_offset = (UIDevice.currentDevice.userInterfaceIdiom == UIUserInterfaceIdiomPad) ? 224 : 0
    
    @pull_up_view = StyledPullableView.alloc.initWithFrame(CGRectMake(x_offset, 0, 320, PUlL_UP_VIEW_HEIGHT)).tap do |view|
      view.opened_center     = CGPointMake(160 + x_offset, (self.view.frame.size.height - PUlL_UP_VIEW_HEIGHT / 2))
      view.closed_center     = CGPointMake(160 + x_offset, self.view.frame.size.height + PUlL_UP_VIEW_HEIGHT / 2 - 30)
    ...
    @pull_down_view = StyledPullableView.alloc.initWithFrame(CGRectMake(x_offset, 0, 320, PULL_DOWN_VIEW_HEIGHT)).tap do |view|
      view.opened_center = CGPointMake(160 + x_offset, PULL_DOWN_VIEW_HEIGHT / 2)
      view.closed_center = CGPointMake(160 + x_offset, - PULL_DOWN_VIEW_HEIGHT / 2 + 30)
      view.center        = view.closed_center
      view.should_receive_touch { @pullable }
      self.view.addSubview(view)
    end
